  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-t border-neutral-4 dark:border-zinc-800 bg-white dark:bg-zinc-950 shrink-0 transition-colors duration-300">
        <div className="flex flex-row items-center gap-2 w-full border border-neutral-4 dark:border-zinc-800 rounded-xl px-3 py-2 bg-neutral-1 dark:bg-zinc-900 focus-within:ring-offset-0 focus-within:ring-1 focus-within:ring-accent dark:focus-within:border-zinc-500 focus-within:bg-white dark:focus-within:bg-zinc-950 transition-all">
          <input
          ...
          <button
            className={`font-inter text-xs font-semibold px-4 py-2 rounded-lg transition-all ${
              currentMessage.trim() === "" || loading?.ask_ai
                ...
                : "bg-accent dark:bg-purple-600 text-white hover:bg-accent/80  dark:hover:bg-purple-700 cursor-pointer shadow-sm"
            }`}
